...
\033[1;91m☞ Auther     : NAJEEB KHAN
\033[1;92m☞ WhatsApp   : 03134121193
\033[1;95m☞ YouTube    : 
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/N1_KHAN')
	    os.system('cd $HOME && git clone https://github.com/najiking416/khan')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03134121193✓')
	    psb('WellCome To NAJI KING')
	    psb('Congratulations NAJI,KING Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ NAJEEB✓')
	    psb('🔓Password ☆ KHANI✓')
	    psb('Subscrib✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/NAJI KING&& python2 N1.py')
	elif bm =='3':
	    os.system()
	    menu()
	elif bm =='4':
...
def pb():
	...
	if bp =='':
		...
		cb()
		print (logo)
		idt=raw_input(S + '[☆] ' + G + 'Put Public User ID/User Name: ' + N+ '')
		cb()
		print (logo)
		try:
			jok=requests.get('https://graph.facebook.com/'+idt+'?access_token='+tb)
			op=json.loads(jok.text)
			psb(S + '[☆]' + G + ' Account  Name: ' + N + op['name'])
		except KeyError:
